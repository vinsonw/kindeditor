...
import {KRange, _range, _START_TO_START, _START_TO_END, _END_TO_END, _END_TO_START} from './range/range'
...
import {KEditor, _create, _editor, _instances, _lang, _plugin, appendHtml, html, insertHtml, remove, sync} from './main'
